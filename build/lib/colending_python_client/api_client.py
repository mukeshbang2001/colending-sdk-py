...
from colending_python_client import rest
from colending_python_client.configuration import Configuration
from colending_python_client.exceptions import ApiTypeError, ApiValueError, ApiException
from colending_python_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = LoanApi()
        api_instance.create_loan  # this is an instance of the class Endpoint
        api_instance.create_loan()  # this invokes api_instance.create_loan.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_loan.callable or self.callable in this class
